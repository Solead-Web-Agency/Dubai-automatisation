...
async function generateStoryAd({ title, price, location, type, propertyImageBuffer, filename }) {
  ...
  try {
    ...
    // Test 1: Texte simple en noir pour vérifier que le rendu fonctionne
    ctx.fillStyle = 'black';
    ctx.font = 'bold 48px sans-serif';
    ctx.textAlign = 'left';
    ctx.fillText('TEST TEXTE', 70, 100);
    console.log('✅ Texte de test dessiné en noir');
    
    // Test 2: Rectangle de fond pour voir la zone de texte
    ctx.fillStyle = 'rgba(255, 0, 0, 0.3)'; // Rouge semi-transparent
    ctx.fillRect(70, 150, 400, 300);
    console.log('✅ Rectangle de fond dessiné');
    ...
    const textY2 = 79 + 90 + 100;
    console.log('  - Position Y2:', textY2);
    ctx.fillText('APPARTEMENT 70M2', 70, textY2);
    console.log('✅ Texte "APPARTEMENT 70M2" dessiné à (70,', textY2, ')');
    
    // "À DUBAI DÈS 250.000€" en rouge
    ctx.fillStyle = '#ff2525';
    console.log('  - Nouvelle couleur appliquée:', ctx.fillStyle);
    const textY3 = 79 + 90 + 200;
    console.log('  - Position Y3:', textY3);
    ctx.fillText('À DUBAI DÈS 250.000€', 70, textY3);
    console.log('✅ Texte "À DUBAI DÈS 250.000€" dessiné à (70,', textY3, ')');
